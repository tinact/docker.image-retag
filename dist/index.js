...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const imageOldTag = core.getInput('image_old_tag');
            const imageNewTag = core.getInput('image_new_tag') || 'latest';
            ...
            pull(repositoryOld, registry)
                .then(() => core.info(`Successfully Pulling docker image from ${registry}.`))
                .catch(err => core.setFailed(err.message));
